...
export const selectedEditedTask = (state: RootState) => state.task.editedTask;
export const selecteTasks = (state: RootState) => state.task.tasks;
export const selecteUsers = (state: RootState)=> state.task.users;
